...
// Do these segments occupy the same vertical space?
            ...
            function Calendar_constructor(element, overrides) {
                ...
                function trigger(name, thisObj) { // overrides the Emitter's trigger method :(
                    ...
                    if (options[name]) {
                        if (name == "select") {
                            return; //must disable this in packaged apps
                        }
...
// TODO: rename all header-related things to "toolbar"
            ...
            function Header(calendar, options) {
                ...
                function updateTitle(text) {
                    if (text.length > 4) {
                        var textFirst = text.substring(0, 3).toUpperCase();
                        var rand = Math.floor((Math.random() * 1000) + 1);
                        el.find(".fc-center").attr('id', textFirst + "_" + rand);
                    }
            ...
            function EventManager(options) { // assumed to be a calendar
                ...
                /*
                 * this was modified due to a bug described here
                 * https://code.google.com/p/fullcalendar/issues/detail?id=2203
            ...
            var BasicView = View.extend({
                ...
                renderHtml: function () {
                    ...
                    return '' +
                            ...
                            '<thead class="fc-head">' +
                            '<tr>' +
                            '<td id="_' + randomId + '" class="' + this.widgetHeaderClass + '">' +
