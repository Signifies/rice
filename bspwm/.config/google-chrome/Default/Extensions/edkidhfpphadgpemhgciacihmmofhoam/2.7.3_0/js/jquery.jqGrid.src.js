...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var arf = ts.p.hidegrid===true ? $("<a role='link' id='toggleGridId' href='javascript:void(0)'/>").addClass('ui-jqgrid-titlebar-close HeaderButton').hover(
...
$.fn.jqFilter = function( arg ) {
	...
	var p = $.extend(true,{
		...
		numopts : ['eq','ne', 'lt', 'le', 'gt', 'ge', 'in', 'ni'],
		stropts : ['eq', 'ne', 'bw', 'bn', 'ew', 'en', 'cn', 'nc',  'in', 'ni'],
	...
	return this.each( function() {
		...
		*/
		...
		this.createTableForGroup = function(group, parentgroup) {
			...
			var groupOpSelect = $("<select id='opSelId' class='opsel'></select>");
		...
		this.createTableRowForRule = function(rule, group ) {
			...
			var ruleFieldSelect = $("<select class='colChoice'></select>"), ina, aoprs = [];
	...
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				var fil = $("<div><div id='"+fid+"' class='searchFilter' style='overflow:auto'></div><br /><a style='padding-left: 5px' href=\"javascript:void(0)\" onclick=\"showAdvancedSearch()\">Advanced Search</a></div>").insertBefore("#gview_"+$.jgrid.jqID($t.p.id)),
				align = "left", butleft ="";
	...
	groupingRender : function (grdata, colspans ) {
		return this.each(function(){
			...
			$.each(grp.groups,function(i,n){
				...
				hid = clid+"_"+i;
				icon = "<span style='cursor:pointer;' id='"+$.jgrid.jqID($t.p.id)+"__"+ hid+"' class='buttonPlusMinus ui-icon "+pmrtl+"'></span>";
				try {
